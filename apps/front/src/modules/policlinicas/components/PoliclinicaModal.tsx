...
import type { PoliclinicaFormData } from "../types";

interface PoliclinicaModalProps {
    visible: boolean;
    editingId: string | null;
    onCancel: () => void;
    onSubmit: (data: PoliclinicaFormData) => void;
    loading: boolean;
    initialValues?: PoliclinicaFormData;
}

const PoliclinicaModal: React.FC<PoliclinicaModalProps> = ({
    visible,
    editingId,
    onCancel,
    onSubmit,
    ...
    return (
        <Modal
            title={editingId ? "Editar Policlínica" : "Nova Policlínica"}
            open={visible}
            onCancel={onCancel}
            footer={null}
            destroyOnClose
                ...
                >
                    <Controller
                        ...
                        render={({ field }) => (
                            <Input
                                {...field}
                                placeholder="Digite o nome da policlínica"
                            />
                        )}
                    />
                </Form.Item>
...
export default PoliclinicaModal;
