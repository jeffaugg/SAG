...
- [SAG (Sistema de Apoio à Gestante)](#sag-sistema-de-apoio-à-gestante)
    - [📋 Índice](#-índice)
    ...
    - [🔧 Comandos Úteis](#-comandos-úteis)
        ...
        - [Ambiente Local via Docker (usando `.env`)](#ambiente-local-via-docker-usando-env)
...
No Windows, rode esses scripts em um shell compatível com Bash, como Git Bash ou WSL.
